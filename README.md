...
```
---
## 📷 Capturas de Pantalla buena accesibilidad
...
---
## 📷 Screenshots poor accessibility
| Example 1 | Example 2 |
|----------------------|------------------|
...
## Example 1: Contact Form (Code with errors)
```html
<!DOCTYPE html>
<html lang="es">
<head>
...
## Example 2: Product List (Code with errors)
```html
<!DOCTYPE html>
<html lang="es">
<head>
...
```
---
## 📷 Screenshots good accessibility
| Example 1 Good | Example 2 Good |
|----------------------|------------------|
| ![Contact Form](./ejemplo1BIEN/image.png) | ![List of products](./ejemplo2Bien/ejemplo2Bien.png) |

---

## Example 1: Contact Form (corrected)
```html
<!DOCTYPE html>
<html lang="es">
<head>
...
## Example 2: Product List (Corrected)
```html
<!DOCTYPE html>
<html lang="es">
<head>
...
Review and correct this HTML and CSS code to ensure compliance with WCAG 2.1 standards (levels A, AA and AAA). Focus especially on resolving contrast errors: make sure the ratio between text and background is at least 4.5:1 for normal text and 3:1 for large text. If you find insufficient contrast (e.g. white text #ffffff on blue background #007bff), adjust the colors in the CSS: darken the background (e.g. #0056b3) or lighten the text (e.g. #e0e0e0). Do not ignore any contrast errors.

In addition:

- Add ARIA attributes (aria-label, aria-describedby, role) where needed.
- Improve semantics with HTML5 tags (<header>, <main>, <section>, etc.).
- Make sure images have descriptive alt or alt=“” if they are decorative.
- Check the hierarchy of headings (\<h1>, \<h2>, etc).
- Make interactive elements (links, buttons, forms) keyboard accessible and have visible focus.
- En formularios, asocia etiquetas (<label>) y marca campos obligatorios con aria-required o required.
- Make sure CSS does not rely on color alone to convey information.

Apply these changes and return the corrected HTML and CSS code.
